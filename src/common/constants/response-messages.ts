...
export enum Messages {
  ...
  INVALID_USER_CREDENTIALS = 'Usuario o contraseña incorrectos. Verifica tus datos e intenta nuevamente.',
  NO_PERMISSION_USER = 'El usuario no tiene roles asignados.',
  INVALID_USER = 'El usuario no existe o no tiene un estado válido.',
  INVALID_CREDENTIALS = 'No se pudo iniciar sesión con las credenciales proporcionadas.',
  INVALID_CURRENT_PASSWORD = 'La contraseña actual es incorrecta.',
  INACTIVE_USER = 'Tu cuenta se encuentra inactiva. Solicita apoyo al administrador para habilitarla.',
  PENDING_USER = 'Tu cuenta aún no fue activada. Revisa tu correo electrónico para completar la activación.',
  ...
  USER_BLOCKED = 'Tu cuenta fue bloqueada temporalmente por varios intentos fallidos de inicio de sesión. Revisa tu correo electrónico para desbloquearla.',
