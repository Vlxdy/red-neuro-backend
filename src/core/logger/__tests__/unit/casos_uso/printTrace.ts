...
export async function printTrace() {
  logger.trace('Mensaje para el cliente')
  logger.trace('Mensaje para el cliente', { algun: 'metadato' })
  logger.trace('Mensaje para el cliente', { algun: 'metadato' }, 'MÓDULO')
  logger.trace({
