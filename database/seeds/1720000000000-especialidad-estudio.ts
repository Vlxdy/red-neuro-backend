...
import { EstudioEstado } from '@/application/estudio/constants'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const especialidades = [
      {
        nombre: 'Cardiología',
        descripcion:
          'Especialidad enfocada en el corazón y el sistema vascular.',
        colorHex: '#E53935',
      },
      {
        nombre: 'Neurología',
        descripcion:
          'Especialidad dedicada al sistema nervioso central y periférico.',
        colorHex: '#3949AB',
      },
      {
        nombre: 'Radiología',
        descripcion:
          'Especialidad que realiza estudios por imágenes diagnósticas.',
        colorHex: '#00897B',
      },
      {
        nombre: 'Laboratorio Clínico',
        descripcion:
          'Especialidad encargada de análisis clínicos y biomarcadores.',
        colorHex: '#6D4C41',
      },
      {
        nombre: 'Ginecología',
      ...
      },
      {
        ...
        descripcion:
          'Especialidad de lesiones del sistema músculo-esquelético.',
        colorHex: '#78909C',
      },
      {
        nombre: 'Nefrología',
    ...
    const estudios = [
      ...
      },
      {
        ...
        descripcion:
          'Estudio por imagen para tejidos blandos y sistema nervioso.',
        duracionMinutos: 60,
      },
      {
      ...
      },
      {
        ...
        descripcion:
          'Estudio por imagen en cortes para evaluación diagnóstica.',
        duracionMinutos: 45,
      },
      {
