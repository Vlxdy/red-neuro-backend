...
| `DB_SCHEMA_HISTORICOS` | `proyecto` | Esquema para históricos/notificaciones push según entidades actuales. |
| `DB_SCHEMA_HISTORIA_CLINICA` | `proyecto` | Reservado para componentes de historia clínica. |
| `DB_SCHEMA_PLAN_NUTRICIONAL` | `proyecto` | Reservado para plan nutricional. |
| `DB_SCHEMA_EVALUACION` | `proyecto` | Reservado para evaluaciones. |
| `DB_SCHEMA_ARCHIVOS` | `proyecto` | Reservado para archivos/documentos. |
...
| `CITAS_REVISION_DIARIA_CRON` | `0 1 * * *` | Alias legacy que el servicio todavía acepta como fallback. |
